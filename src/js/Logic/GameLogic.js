...
class GameLogic {
	...
	checkGameState(gameobject) {
		...
		if(win) {
			...
			this.view.updateUiAfterEndParty( "Вы победили! Временно игра находится на тестировании и поэтому призов пока нет! Но уже через неделю будут снова разыгрываться призы за выигрыш в этой игре!", "success");
			return true;	
		} else if (win == false) {
